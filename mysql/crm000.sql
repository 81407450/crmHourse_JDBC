...
MySQL - 5.5.48-log : Database - crm000
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`crm000` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `customer_condition`(`condition_id`,`condition_name`,`condition_explain`,`is_used`) values (1,'潜在客户','可能成为客户的人','0'),(2,'意向客户','有意愿车成为客户的人','1'),(3,'交易客户','正在交易的客户','1');
